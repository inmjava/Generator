...
public class DaoHibernateImplTemplate {
  ...
  protected final String TEXT_41 = "> listar(";
  protected final String TEXT_42 = " example, Integer qtdPagina, Integer numPagina) throws Exception {" + NL + "\t\tCollection<";
  protected final String TEXT_43 = "> coll = new ArrayList<";
  ...
  protected final String TEXT_51 = "> listar(";
  protected final String TEXT_52 = " example) throws Exception {" + NL + "\t\treturn this.listar(example, null, null);" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * Listagem de objetos da classe ";
  protected final String TEXT_53 = "." + NL + "\t * " + NL + "\t * @param qtdPagina quantidade de itens listados em cada pagina " + NL + "\t * @param numPagina numero da pagina a ser buscada" + NL + "\t * @return Lista de objetos ";
  protected final String TEXT_54 = NL + "\t * @throws Exception Caso ocorra erro com hibernate/conexao." + NL + "\t */" + NL + "\tpublic Collection<";
  protected final String TEXT_55 = "> listar(Integer qtdPagina, Integer numPagina) throws Exception {" + NL + "\t\treturn this.listar(null, qtdPagina, numPagina);" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * Listagem de objetos da classe ";
  protected final String TEXT_56 = "." + NL + "\t * " + NL + "\t * @return Lista de objetos ";
  protected final String TEXT_57 = NL + "\t * @throws Exception Caso ocorra erro com hibernate/conexao." + NL + "\t */" + NL + "\tpublic Collection<";
  protected final String TEXT_58 = "> listar() throws Exception {" + NL + "\t\treturn this.listar(null, null, null);" + NL + "\t}" + NL + "\t\t" + NL + "\t/**" + NL + "\t * Obtem um objeto da classe ";
  protected final String TEXT_59 = "." + NL + "\t * " + NL + "\t * @param id Chave primaria do objeto" + NL + "\t * @throws Exception Caso ocorra erro com hibernate/conexao." + NL + "\t */" + NL + "\tpublic ";
